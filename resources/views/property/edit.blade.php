<x-app>
    ...
    <div class="card shadow-lg p-3">
        <form action="{{ route('property.update', $property) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <small class="text-muted">Klik pada peta untuk mengubah lokasi koordinat.</small>
            </div>
            
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label>Latitude</label>
                    <input type="text" id="latitude" name="latitude" class="form-control" value="{{ $property->latitude }}" readonly>
                </div>
                <div class="col-md-6 mb-3">
                    <label>Longitude</label>
                    <input type="text" id="longitude" name="longitude" class="form-control" value="{{ $property->longitude }}" readonly>
                </div>
            </div>
    ...
    <script>
        // Init Map
        var defaultLat = {{ $property->latitude ?: '-6.200000' }};
        var defaultLng = {{ $property->longitude ?: '106.816666' }};
        var zoom = {{ $property->latitude ? '15' : '13' }};
